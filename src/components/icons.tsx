...
export function BuildABallotLogo(props: IconProps) {
  return (
    <svg viewBox="0 0 60 36" fill="currentColor" aria-label="Build a Ballot" {...props}>
      <text x="0" y="14" fontFamily="'Libre Franklin', Inter, sans-serif" fontWeight="700" fontSize="13" letterSpacing="0.5">
        BUILD A
      </text>
      <text x="0" y="30" fontFamily="'Libre Franklin', Inter, sans-serif" fontWeight="700" fontSize="13" letterSpacing="0.5">
        BALLOT
      </text>
    </svg>
  );
